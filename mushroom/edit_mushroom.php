...
<html lang="th-TH">
<head>
	<title>MushroomFinder-แก้ไขข้อมูลเห็ด</title>
...
<body>
	...
	<div class="w3-main" style="margin-left:200px;margin-top:43px;padding-left: 20px;padding-right: 20px;">
		<header class="w3-container" style="padding-top:22px;font-size: 25px;color: #583D28;">
  		...
  		<form action="update_mushroom.php" method="post" enctype="multipart/form-data">
  			<?php
            	include 'connect.php';
        		$id = $_GET['id'];
			...
			<div class="row">
				<div class="col-xl-3">
					...
					<input name="mushroom_id" type="text" value="<?php echo $id?>" readonly>
					<label for="txtname">ชื่อเห็ด :</label>
					<input name="txtname" type="text" value="<?php echo $result['Mushroom_name']?>">
					<label for="txtlocalname">ชื่อท้องถิ่น :</label>
					<input name="txtlocalname" type="text" value="<?php echo $result['Mushroom_localname']?>">
					<label for="txtcommonname">ชื่อสามัญ :</label>
					<input name="txtcommonname" type="text" value="<?php echo $result['Mushroom_commonname']?>">
					<label for="txtscience">ชื่อทางวิทยาศาสตร์ :</label>
					<input  name="txtscience" type="text" value="<?php echo $result['Mushroom_science']?>">
					<label for="txtfamily">วงศ์ของเห็ด :</label><br>
					<select name="txtfamily" class="mb-2">
						<option value="<?php echo $result['MushroomFamily_Id'] ?>" hidden>Selected : <?php echo $result['MushroomFamily_Id'] ?></option>
						<?php
							include 'connect.php';
					...
					<select name="txttype" class="mb-2">
						<option value="<?php echo $result['Mushroom_type'] ?>" hidden>Selected : <?php echo $result['Mushroom_type'] ?></option>
					...
					<textarea name="txtbenefit"><?php echo $result['Mushroom_benefit'] ?></textarea>
				</div>
				<div class="col-xl-3">
					<label for="txthabitat">ถิ่นอาศัย/ลักษณะของการขึ้น :</label>
					<input name="txthabitat" type="text" value="<?php echo $result['Mushroom_habitat'] ?>">	
					<label>รูปแบบการเจริญเติบโต : <?php echo $result['Mushroom_growth'] ?></label><br>
					<label>
					...
					<label for="radius">ความยาวเส้นผ่าศูนย์กลาง :&nbsp
						<input name="radius" type="text" style="width: 20%;" value="<?php echo $result['Radius'] ?>">&nbspมม.
					</label><br>
					<label for="height">ความสูงของหมวกเห็ด :&nbsp
						<input name="height" type="text" style="width: 20%;" value="<?php echo $result['Height'] ?>">&nbspมม.
					</label><br>
					<label for="txtcolor">สีหมวกเห็ด :&nbsp</label>
					<input  name="txtcolor" type="text" style="width: 65%;" value="<?php echo $result['Cap_color'] ?>"><br>
					<label for="txtdescription">สรุป :</label><br>
					<textarea name="txtdescription"><?php echo $result['Mushroom_description'] ?></textarea>
					<label>รูป :
                    	<input type="file" id="img" accept="img/mushroom/" name="img" onchange="showPreview(event);">
                    	<img id="img_preview" width="300" style="padding: 16px 0;max-width: 100%" src="img/mushroom/<?php echo $result['Mushroom_icon'] ?>">
                    </label>
				</div>
				<div class="col-xl-6">
					<div class="tab">
						<label>ลักษณะรูปร่างหมวกเห็ดเมื่อมองจากด้านบน :&nbsp</label><img width="100" style="padding: 16px 0;max-width: 100%" src="img/cap_up/<?php echo $result['Cap_up'] ?>"><br>
						<label for="cap_up1">
						...
						<label>ลักษณะรูปร่างหมวกเห็ดเมื่อมองจากด้านข้าง :&nbsp</label><img width="100" style="padding: 16px 0;max-width: 100%" src="img/cap_side/<?php echo $result['Cap_side'] ?>"><br>
						<label for="cap_side1">
  					...
  					<div class="tab">
  						<label>ลักษณะตรงกลางของหมวกเห็ด :&nbsp</label><img width="100" style="padding: 16px 0;max-width: 100%" src="img/cap_center/<?php echo $result['Cap_center'] ?>"><br>
						...
						<label>ลักษณะขอบหมวกเห็ด :&nbsp</label><img width="100" style="padding: 16px 0;max-width: 100%" src="img/cap_margin/<?php echo $result['Cap_margin'] ?>"><br>
  					...
  					<div class="tab">
  						<label>ลักษณะพื้นผิวด้านบนหมวกเห็ด :&nbsp</label><?php echo $result['Surface_up'] ?>&nbsp<img width="100" style="padding: 16px 0;max-width: 100%" src="img/surface_up/<?php echo $result['Surface_up_pic'] ?>"><br>
  					...
  					<div class="tab">
  						<label>ลักษณะพื้นผิวขอบหมวกเห็ด :&nbsp</label><?php echo $result['Surface_margin'] ?>&nbsp<img width="100" style="padding: 16px 0;max-width: 100%" src="img/surface_margin/<?php echo $result['Surface_margin_pic'] ?>"><br>
  					...
  					<div class="tab" id="undercap">
  						<label>ลักษณะใต้หมวกเห็ด :&nbsp</label>&nbsp<?php echo $result['Undercap'] ?><br>
						<label>
						...
						<div id="gills" class="collapse" data-parent="#undercap">
							<label>ลักษณะการติดของครีบบริเวณก้าน :&nbsp</label><img width="100" style="padding: 16px 0;max-width: 100%" src="img/gills_stipe/<?php echo $result['Gills_stipe'] ?>"><br>
							...
							<label>ลักษณะของครีบ :&nbsp</label><?php echo $result['Gills'] ?>&nbsp<img width="100" style="padding: 16px 0;max-width: 100%" src="img/gills/<?php echo $result['Gills_pic'] ?>"><br>
  							<label for="gills1">
							...
							<input  name="txtgills_color" type="text" style="width: 30%;" value="<?php echo $result['Gills_color'] ?>">&nbsp
							<label>ความถี่ของครีบ :</label>
							<select name="txtgills_freq" class="mb-2"  style="width: 30%;">
								<option value="<?php echo $result['Gills_freq'] ?>" hidden> Selected : <?php echo $result['Gills_freq'] ?></option>
						...
						<div id="pores" class="collapse" data-parent="#undercap">
							<label>ลักษณะของปากรู :&nbsp</label><?php echo $result['Pores'] ?><br>
  							<label for="pores1">
							...
							<label>รูปร่างของรู :&nbsp</label><?php echo $result['Pores_shape'] ?><br>
							...
							<input  name="txtpores_color" type="text" style="width: 30%;" value="<?php echo $result['Pores_color'] ?>">
						</div>
						<div id="ridges" class="collapse" data-parent="#undercap">
							<label>ลักษณะของสันนูน :&nbsp</label><?php echo $result['Ridges'] ?><br>
  							<label for="ridges1">
							...
							<input  name="txtridges_color" type="text" style="width: 30%;" value="<?php echo $result['Ridges_color'] ?>">
						</div>
						<div id="teeth" class="collapse" data-parent="#undercap">
							<label for="teeth_width">ความกว้างของฟัน :&nbsp
								<input name="teeth_width" type="text" style="width: 20%;" value="<?php echo $result['Teeth_width'] ?>">&nbspมม.
							</label><br>
							<label for="teeth_length">ความยาวของฟัน :&nbsp
								<input name="teeth_length" type="text" style="width: 20%;" value="<?php echo $result['Teeth_length'] ?>">&nbspมม.
							</label><br>
							<label for="txtteeth_color">สีของฟัน :&nbsp</label>
							<input  name="txtteeth_color" type="text" style="width: 30%;" value="<?php echo $result['Teeth_color'] ?>">
						</div>
						<div id="flat" class="collapse" data-parent="#undercap">
							<label for="txtflat_color">สี :&nbsp</label>
							<input  name="txtflat_color" type="text" style="width: 30%;" value="<?php echo $result['Flat_color'] ?>">
						</div>
  					</div>
  					<div class="tab">
  						<label>ก้าน :&nbsp</label><?php echo $result['Stipe'] ?><br>
						<label>
						...
						<label>ลักษณะของก้าน :&nbsp</label><?php echo $result['Stipe_type'] ?>&nbsp<img width="150" style="padding: 16px 0;max-width: 100%" src="img/stipe/<?php echo $result['Stipe_type_pic'] ?>"><br>
						<label>
						...
						<label>ลักษณะก้านด้านใน :&nbsp</label><img width="100" style="padding: 16px 0;max-width: 100%" src="img/stipe_in/<?php echo $result['Stipe_in'] ?>"><br>
						<label for="stipe_in1">
						...
						<label>ลักษณะก้านด้านนอก :&nbsp</label><img width="100" style="padding: 16px 0;max-width: 100%" src="img/stipe_out/<?php echo $result['Stipe_out'] ?>"><br>
						...
						<label>ลักษณะโคนก้าน :&nbsp</label><img width="100" style="padding: 16px 0;max-width: 100%" src="img/stipe_base/<?php echo $result['Stipe_base'] ?>"><br>
						...
						<label>ลักษณะพื้นผิวก้าน :&nbsp</label><?php echo $result['Stipe_surface'] ?>&nbsp<img width="100" style="padding: 16px 0;max-width: 100%" src="img/surface_stipe/<?php echo $result['Stipe_surface_pic'] ?>"><br>
  					...
  					<div class="tab">
  						<label>วงแหวน :&nbsp</label><?php echo $result['Ring'] ?><br>
						<label>
						...
						<label>ลักษณะของวงแหวน :&nbsp</label><?php echo $result['Ring_type'] ?><br>
						...
						<label>กระเปาะหุ้มโคนก้าน :&nbsp</label><?php echo $result['Volva'] ?><br>
						<label>
						...
						<input  name="txtvolva_color" type="text" style="width: 65%;" value="<?php echo $result['Volva_color'] ?>">
  					</div>
